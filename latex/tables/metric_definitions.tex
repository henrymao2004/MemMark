...
Utility
  & \locomo{} F1
  & Set-based answer overlap used by \amem{} for paper-comparability:
  ...
  & ROUGE-L
  & Longest-common-subsequence recall-oriented overlap between the
    generated answer and the reference answer, measuring whether the
    generated answer preserves the reference content order. \\

\midrule

Watermark reliability
  & Bit recovery rate
  & Fraction of embedded watermark bits correctly recovered from the
    decoded memory trace. \\

  & Decode success rate
  & Fraction of sessions in which the complete embedded watermark message
    is decoded correctly. \\

  & False-positive rate (FPR)
  & Fraction of unwatermarked sessions incorrectly accepted as carrying a
    valid watermark. \\

  & Wrong-key acceptance rate
  & Fraction of sessions decoded with an incorrect key that are incorrectly
    accepted as valid. \\
